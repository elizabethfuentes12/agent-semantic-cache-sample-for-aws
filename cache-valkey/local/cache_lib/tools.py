...
_UA = {"User-Agent": "semantic-cache-valkey-local/1.0"}
...
def search_flights(
    ...
    with urllib.request.urlopen(request, timeout=25) as response:  # nosemgrep: dynamic-urllib-use-detected  # nosec B310 - URL built from a fixed public API base, not user-controlled
