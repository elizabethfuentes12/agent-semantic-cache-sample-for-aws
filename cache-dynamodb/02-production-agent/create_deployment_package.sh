...
# https://docs.aws.amazon.com/bedrock-agentcore/latest/devguide/runtime-get-started-code-deploy.html?trk=87c4c426-cddf-4799-a299-273337552ad8&sc_channel=el
set -euo pipefail
...
# Install dependencies for ARM64 — no valkey, only strands + bedrock-agentcore + boto3
uv pip install \
