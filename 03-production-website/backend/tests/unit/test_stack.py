...
class TestSSMParameters:
    ...
    def test_exactly_three_ssm_parameters(self):
        _, template = _make_stack()
        ...
        template.has_resource_properties("AWS::Lambda::Function", {
            "Environment": assertions.Match.object_like({
                "Variables": assertions.Match.object_like({
                    ...
                    "APPSYNC_HTTP_ENDPOINT_PARAM": "/appsync/http_endpoint",
                    "APPSYNC_API_KEY_PARAM": "/appsync/api_key",
            ...
            "PolicyDocument": assertions.Match.object_like({
                "Statement": assertions.Match.array_with([
                    assertions.Match.object_like({
                        ...
                        "Effect": "Allow",
                        "Resource": "arn:aws:ssm:*:*:parameter/appsync/*",
                    }),
                ]),
            }),
        }))
